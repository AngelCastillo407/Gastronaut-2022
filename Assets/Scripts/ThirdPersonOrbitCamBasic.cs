...
public class ThirdPersonOrbitCamBasic : MonoBehaviour 
{
	...
	public string XAxis = "Horizontal";                                  // The default horizontal axis input name.
	public string YAxis = "Vertical";                                  // The default vertical axis input name.
	...
	void Update()
	{
        // Only if player holds left click
